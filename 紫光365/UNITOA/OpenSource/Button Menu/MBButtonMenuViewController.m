...
- (void)viewDidLoad
{
    ...
    frame.origin.y = frame.size.height-(frame.size.height/4);
    frame.size.height /= 4;
    ...
    line1.frame = CGRectMake(0, frame.size.height/3, frame.size.width, 0.5);
    line1.backgroundColor = GETColor(204, 204, 204);
    [_buttonView addSubview:line1];
    
    UIView *line2 = [[UIView alloc] init];
    line2.frame = CGRectMake(0, frame.size.height/3*2, frame.size.width, 0.5);
    line2.backgroundColor = GETColor(204, 204, 204);
...
- (UIButton *) buttonWithTitle:(NSString *)title forIndex:(NSUInteger)index
{
    ...
    if (index == _cancelButtonIndex) {
        [button setTitleColor:GETColor(255, 34, 39) forState:UIControlStateNormal];
        [button setBackgroundColor:[UIColor whiteColor]];
    }
    else{
        [button setBackgroundColor:[UIColor whiteColor]];
        [button setTitleColor:GETColor(59, 126, 194) forState:UIControlStateNormal];
    }
