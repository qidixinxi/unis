...
#define FACE_SIGNIN_NEW       @"facesigninnew.php"              //94、发起当面签到
#define FACE_SIGNIN_URL        @"facesignin.php"                //95、当面签到
#define FACE_SIGNIN_LIST      @"facesigninlist.php"             //96、发起的当面签到列表
#define FACE_SIGNIN_joinlist  @"facesigninjoinlist.php"         //97、参与的当面签到列表
#define FACE_SIGNIN_USERLIST  @"facesigninuserlist.php"         //98、当面签到用户列表
#define SIGNIN_INVALIDATE     @"facesignininvalidate.php"       //99、作废当面签到

#pragma mark --------工作日志接口--------------------------------------
#define SIZHI_NEW_URL          @"rizhinew.php"                  //79、发表/修改日志
#define RIZHI_COUNT_URL        @"rizhicount.php"                //80、日志统计
#define RIZHI_GROUP_URL        @"rizhigroup.php"                //81、日志群组
#define RIZHI_GROUP_SET        @"rizhigroupset.php"             //82、设置日志群组
#define RIZHI_LIST_URL         @"rizhilist.php"                 //83、日志列表
#define RIZHI_VIEW_URL         @"rizhiview.php"                 //84、查看日志

#pragma mark --------文件柜日志接口--------------------------------------
#define YOUPAN_LIST_URL        @"yunpanlist.php"                //85、云盘列表
#define YUNPAN_NEW_URL         @"yunpannew.php"                 //86、新增/修改文件
#define YUNPAM_DEL_URL         @"yunpandel.php"                 //87、删除文件
#define YUNPAN_COPY_URL        @"yunpancopy.php"                //88、复制/移动文件
