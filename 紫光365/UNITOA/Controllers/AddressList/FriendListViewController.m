...
- (void)getFriendList
{
    ...
    } andCathtype:2 andID:1 andtypeName:@"friendList"];
}
...
- (void)getFriendDetail:(FriendIfo *)friendModel
{
    ...
    } andCathtype:2 andID:2 andtypeName:@"friendDetail"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if ([arr count] > indexPath.row) {
            ...
            [cell.imgView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGE_BASE_URL,str.friendModel.icon]] placeholderImage:[UIImage imageNamed:@"user_default_small_96"]];
        } else {
