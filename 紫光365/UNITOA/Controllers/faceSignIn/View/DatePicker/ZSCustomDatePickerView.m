...
@interface ZSCustomDatePickerView()
{
...
@implementation ZSCustomDatePickerView
...
{
    nowPickerShowTimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(17.0, 100.0, 278.5, 18)];
    [nowPickerShowTimeLabel setBackgroundColor:[UIColor clearColor]];
    [nowPickerShowTimeLabel setFont:[UIFont systemFontOfSize:18.0]];
    [nowPickerShowTimeLabel setTextColor:RGBA(21, 126, 251, 1)];
    ...
    sendDateTime = [NSString stringWithFormat:@"%@-%d-%d",[dateString substringWithRange:NSMakeRange(0, 4)],monthInt,dayInt];
    ...
    OkBtn.frame = CGRectMake((SCREEN_WIDTH - 100)/2, selectTimeIsNotLegalLabel.frame.size.height + selectTimeIsNotLegalLabel.frame.origin.y + 10, 100, 40);
    [OkBtn addTarget:self action:@selector(btnClick:) forControlEvents:UIControlEventTouchUpInside];
    OkBtn.layer.borderColor = RGBA(22, 102, 249, 1).CGColor;
    OkBtn.layer.borderWidth = 1;
    [OkBtn setTitleColor:RGBA(21, 126, 251, 1) forState:UIControlStateNormal];
...
- (void)btnClick:(UIButton *)sender{
    [self.delegate sendTime:sendDateTime];
}
//设置年月日时分的滚动视图
...
- (void)setAfterScrollShowView:(MXSCycleScrollView*)scrollview  andCurrentPage:(NSInteger)pageNumber
{
    ...
    [currentLabel setTextColor:RGBA(73.0, 73.0, 73.0,1.0)];
...
- (void)selectSetBroadcastTime
{
    ...
    sendDateTime = [NSString stringWithFormat:@"%d-%d-%d",yearInt,monthInt,dayInt];
...
- (void)scrollviewDidChangeNumber
{
    ...
    UILabel *minuteLabel = [[(UILabel*)[[minuteScrollView subviews] objectAtIndex:0] subviews] objectAtIndex:3];
    UILabel *secondLabel = [[(UILabel*)[[secondScrollView subviews] objectAtIndex:0] subviews] objectAtIndex:3];
    [yearLabel setTextColor:RGBA(73.0, 73.0, 73.0,1.0)];
    [monthLabel setTextColor:RGBA(73.0, 73.0, 73.0,1.0)];
    [dayLabel setTextColor:RGBA(73.0, 73.0, 73.0,1.0)];
    [hourLabel setTextColor:RGBA(73.0, 73.0, 73.0,1.0)];
    [minuteLabel setTextColor:RGBA(73.0, 73.0, 73.0,1.0)];
    [secondLabel setTextColor:RGBA(73.0, 73.0, 73.0,1.0)];
