    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        if (indexPath.section == 0) {
            ...
            if (indexPath.row == 0) {
                ...
                cell.imgView.image = [UIImage imageNamed:@"facesign"];
                cell.nameLable.text = LOCALIZATION(@"face_sign_in");
            }
            else if(indexPath.row == 4){
                cell.imgView.image = [UIImage imageNamed:@"signin"];
                cell.nameLable.text = LOCALIZATION(@"sign_in");
            }
            else if(indexPath.row == 6){
                cell.imgView.image = [UIImage imageNamed:@"workLog"];
                cell.nameLable.text = LOCALIZATION(@"workLog");
            }
            else if(indexPath.row == 5){
                cell.imgView.image = [UIImage imageNamed:@"meetSckedule"];
                cell.nameLable.text = LOCALIZATION(@"meetSckedule");
            }
            else if(indexPath.row == 7){
                cell.imgView.image = [UIImage imageNamed:@"fileStore"];
                cell.nameLable.text = LOCALIZATION(@"filestore");
            }
        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        // 群组
           ...
           FaceSignListViewController *signList = [[FaceSignListViewController alloc]init];
           ...
           signList.friendID = GET_USER_ID;
           [self.navigationController pushViewController:signList animated:YES];
       }
       else if(indexPath.row == 6){
           FileMainNavViewController *fileMainNav = [[FileMainNavViewController alloc]init];
           [self.navigationController pushViewController:fileMainNav animated:YES];
       }
       else if(indexPath.row == 5){
           GcalendarViewController *gCalendar = [[GcalendarViewController alloc]init];
           [self.navigationController pushViewController:gCalendar animated:YES];
       }
       else if(indexPath.row == 7){
           FileMainNavViewController *fileMainNav = [[FileMainNavViewController alloc]init];
           [self.navigationController pushViewController:fileMainNav animated:YES];
