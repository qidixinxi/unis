...
- (void)initilization{
    ...
    peakImageAry = [[NSArray alloc] initWithObjects:[[[UIImage alloc] initWithContentsOfFile:K_contentsOfFilePNG(@"speaker_0")] autorelease],[[[UIImage alloc] initWithContentsOfFile:K_contentsOfFilePNG(@"speaker_1")] autorelease],[[[UIImage alloc] initWithContentsOfFile:K_contentsOfFilePNG(@"speaker_2")] autorelease],[[[UIImage alloc] initWithContentsOfFile:K_contentsOfFilePNG(@"speaker_3")] autorelease], nil];
//    trashImageAry = [[NSArray alloc]initWithObjects:kTrashImage1,kTrashImage2,kTrashImage3,kTrashImage2, nil];
    trashImageAry = [[NSArray alloc] initWithObjects:[[[UIImage alloc] initWithContentsOfFile:K_contentsOfFilePNG(@"speaker_0")] autorelease],[[[UIImage alloc] initWithContentsOfFile:K_contentsOfFilePNG(@"speaker_0")] autorelease],[[[UIImage alloc] initWithContentsOfFile:K_contentsOfFilePNG(@"speaker_0")] autorelease], nil];
}
