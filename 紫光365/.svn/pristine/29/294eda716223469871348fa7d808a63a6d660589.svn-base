...
{
    NSString *pathds = NSTemporaryDirectory();
    return pathds;//[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES)objectAtIndex:0];
...
+ (NSString*)getPathByFileName:(NSString *)_fileName ofType:(NSString *)_type
{
    ...
    NSURL * url = [NSURL URLWithString:fileDirectory];
